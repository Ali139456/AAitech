                    ...
                    <ul className="space-y-4">
                      {course.keyBenefits.map((benefit, index) => (
                        <motion.li
                          ...
                          viewport={{ once: true }}
                          transition={{ duration: 0.4, delay: index * 0.1 }}
                          className="flex items-start gap-4 p-4 rounded-xl bg-white/50 hover:bg-white transition-colors duration-300"
                        >
                          <div className={`w-8 h-8 bg-gradient-to-br ${course.color} rounded-lg flex items-center justify-center flex-shrink-0 shadow-md`}>
                            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          ...
                          <span className="text-gray-800 text-lg font-medium leading-relaxed">{benefit}</span>
                        </motion.li>
                      ))}
                    </ul>
                  </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-8">
                      ...
                      <h2 className="text-2xl md:text-3xl font-bold text-gray-900">What We Deliver</h2>
                    </div>
                    <ul className="space-y-4">
